...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'clang -pthread -shared -L/tools/deps/lib -Wl,--exclude-libs,ALL '
              '-L/tools/deps/libedit/lib -LModules/_hacl',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           '-O3 -Wall -fdebug-default-version=4 -fPIC -I/tools/deps/include '
 ...
 'CONFIGURE_CFLAGS_NODIST': '-flto=thin -g -std=c11 -Wextra '
 ...
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                ...
                "-L/tools/deps/libedit/lib -LModules/_hacl' 'CPPFLAGS= "
                '-fdebug-default-version=4 -fPIC -I/tools/deps/include '
                "-I/tools/deps/include/ncursesw -I/tools/deps/libedit/include'",
 'CONFINCLUDEDIR': '/install/include',
 'CONFINCLUDEPY': '/install/include/python3.12',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.12.0/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/build/Python-3.12.0/lcov-report',
 ...
 'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code '
                    '-DNDEBUG -g -O3 -Wall -fdebug-default-version=4 -fPIC '
                    '-I/tools/deps/include -I/tools/deps/include/ncursesw '
                    '-I/tools/deps/libedit/include -flto=thin -g -std=c11 '
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/build/Python-3.12.0 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/build/Python-3.12.0/`cat pybuilddir.txt`:)./Lib '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare '
                             ...
                             '-fdebug-default-version=4 -fPIC '
                             '-I/tools/deps/include '
                             '-I/tools/deps/include/ncursesw '
                             '-I/tools/deps/libedit/include -flto=thin -g '
 ...
 'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -O3 -Wall -fdebug-default-version=4 -fPIC '
              '-I/tools/deps/include -I/tools/deps/include/ncursesw '
              '-I/tools/deps/libedit/include',
 'PY_CFLAGS_NODIST': '-flto=thin -g -std=c11 -Wextra -Wno-unused-parameter '
                     '-Wno-missing-field-initializers -Wstrict-prototypes '
                     '-Werror=implicit-function-declaration '
 ...
 'PY_CORE_LDFLAGS': '-L/tools/deps/lib -Wl,--exclude-libs,ALL '
                    '-L/tools/deps/libedit/lib -LModules/_hacl -flto=thin -g',
 ...
 'PY_LDFLAGS_NOLTO': '-L/tools/deps/lib -Wl,--exclude-libs,ALL '
                     '-L/tools/deps/libedit/lib -LModules/_hacl -flto=thin',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/Python-3.12.0',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/Python-3.12.0 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.12.0 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.12.0/`cat pybuilddir.txt`:)./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu '
               '/tools/host/bin/python3.12',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/Python-3.12.0 '
               '_PYTHON_PROJECT_BASE=/build/Python-3.12.0 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/build/Python-3.12.0/`cat pybuilddir.txt`:)./Lib '
 ...
 'abs_builddir': '/build/Python-3.12.0',
 'abs_srcdir': '/build/Python-3.12.0',
