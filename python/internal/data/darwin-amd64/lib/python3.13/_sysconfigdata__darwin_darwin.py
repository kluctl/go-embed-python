...
build_time_vars = {
    ...
    "AR": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/tools/llvm/bin/llvm-ar",
    "ARFLAGS": "rcs",
    ...
    "BLDSHARED": "clang -bundle -undefined dynamic_lookup -arch x86_64 -mmacosx-version-min=10.9   -LModules/_hacl",
    "BOOTSTRAP_HEADERS": "\\",
    "BUILDEXE": ".exe",
    ...
    "CC": "clang",
    "CCSHARED": "",
    "CFLAGS": "-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    ",
    "CFLAGSFORSHARED": "",
    "CFLAGS_ALIASING": "-fno-strict-aliasing",
    "CODECS_COMMON_HEADERS": "./Modules/cjkcodecs/multibytecodec.h ./Modules/cjkcodecs/cjkcodecs.h",
    "COMPILEALL_OPTS": "-j0",
    "CONFIGFILES": "configure configure.ac acconfig.h pyconfig.h.in Makefile.pre.in",
    "CONFIGURE_CFLAGS": "-arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    ...
    "CONFIGURE_CPPFLAGS": "-arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "CONFIGURE_LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.9   -LModules/_hacl",
    "CONFIGURE_LDFLAGS_NODIST": "-flto=thin -Wl,-export_dynamic -Wl,-object_path_lto,\"$@\".lto -g",
    "CONFIGURE_LDFLAGS_NOLTO": "-flto=thin",
    "CONFIG_ARGS": "'--build=aarch64-apple-darwin' '--host=x86_64-apple-darwin' '--prefix=/install' '--with-openssl=/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/tools/deps' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' '--enable-shared' '--with-mimalloc' '--enable-optimizations' '--with-lto' '--with-build-python=/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/tools/host/bin/python3.13' 'ac_cv_lib_intl_textdomain=no' 'MACHDEP=darwin' 'ac_sys_system=Darwin' 'ac_sys_release=23.6.0' 'ac_cv_func_ptsname_r=no' '--with-dbmliborder=ndbm' 'ac_cv_buggy_getaddrinfo=no' 'ac_cv_file__dev_ptc=no' 'ac_cv_file__dev_ptmx=no' 'build_alias=aarch64-apple-darwin' 'host_alias=x86_64-apple-darwin' 'CC=clang' 'CFLAGS=-arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'LDFLAGS=-arch x86_64 -mmacosx-version-min=10.9   -LModules/_hacl' 'CPPFLAGS=-arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new'",
    "CONFINCLUDEDIR": "/install/include",
    "CONFINCLUDEPY": "/install/include/python3.13",
    "COREPYTHONPATH": "",
    "COVERAGE_INFO": "/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/Python-3.13.1/coverage.info",
    "COVERAGE_LCOV_OPTIONS": "--rc lcov_branch_coverage=1",
    "COVERAGE_REPORT": "/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/Python-3.13.1/lcov-report",
    "COVERAGE_REPORT_OPTIONS": "--rc lcov_branch_coverage=1 --branch-coverage --title \"CPython 3.13 LCOV report [commit $(shell )]\"",
    "CPPFLAGS": "-I. -I./Include -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    ",
    "CXX": "clang++",
    ...
    "FILEMODE": 644,
    "FREEZE_MODULE": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/tools/host/bin/python3.13 ./Programs/_freeze_module.py",
    "FREEZE_MODULE_BOOTSTRAP": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/tools/host/bin/python3.13 ./Programs/_freeze_module.py",
    ...
    "JIT_DEPS": "\\",
    "LDCXXSHARED": "clang++ -bundle -undefined dynamic_lookup -arch x86_64 -mmacosx-version-min=10.9   -LModules/_hacl",
    "LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.9   -LModules/_hacl",
    "LDLIBRARY": "libpython3.13.dylib",
    "LDLIBRARYDIR": "",
    "LDSHARED": "clang -bundle -undefined dynamic_lookup -arch x86_64 -mmacosx-version-min=10.9   -LModules/_hacl",
    "LDVERSION": "3.13",
    "LIBC": "",
    "LIBDEST": "/install/lib/python3.13",
    "LIBDIR": "/install/lib",
    "LIBEXPAT_A": "Modules/expat/libexpat.a",
    "LIBEXPAT_CFLAGS": "-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/Python-3.13.1/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "LIBEXPAT_HEADERS": "\\",
    "LIBEXPAT_OBJS": "\\",
    ...
    "LLVM_PROF_MERGER": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/tools/llvm/bin/llvm-profdata merge -output=\"$(shell pwd)/code.profclangd\" \"$(shell pwd)\"/*.profclangr",
    "LN": "ln",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/Python-3.13.1 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/Python-3.13.1/`cat pybuilddir.txt`) /var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/tools/host/bin/python3.13",
    "PYTHON_FOR_BUILD_DEPS": "",
    "PYTHON_FOR_FREEZE": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/tools/host/bin/python3.13",
    "PYTHON_FOR_REGEN": "",
    "PYTHON_HEADERS": "\\",
    "PYTHON_OBJS": "\\",
    "PY_BUILTIN_HASHLIB_HASHES": "\"md5,sha1,sha2,sha3,blake2\"",
    "PY_BUILTIN_MODULE_CFLAGS": "-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/Python-3.13.1/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -DPy_BUILD_CORE_BUILTIN",
    "PY_CFLAGS": "-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "PY_CFLAGS_NODIST": "-flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/Python-3.13.1/code.profclangd -I./Include/internal -I./Include/internal/mimalloc",
    "PY_COERCE_C_LOCALE": 1,
    "PY_CORE_CFLAGS": "-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/Python-3.13.1/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -DPy_BUILD_CORE",
    "PY_CORE_LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.9   -LModules/_hacl -flto=thin -Wl,-export_dynamic -Wl,-object_path_lto,\"$@\".lto -g",
    "PY_CPPFLAGS": "-I. -I./Include -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "PY_ENABLE_SHARED": 1,
    "PY_HAVE_PERF_TRAMPOLINE": 0,
    "PY_LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.9   -LModules/_hacl",
    "PY_LDFLAGS_NODIST": "-flto=thin -Wl,-export_dynamic -Wl,-object_path_lto,\"$@\".lto -g",
    "PY_LDFLAGS_NOLTO": "-arch x86_64 -mmacosx-version-min=10.9   -LModules/_hacl -flto=thin",
    ...
    "RESSRCDIR": "",
    "RETSIGTYPE": "void",
    "RUNSHARED": "DYLD_LIBRARY_PATH=/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/Python-3.13.1",
    ...
    "abs_builddir": "/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/Python-3.13.1",
    "abs_srcdir": "/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpuwaefenc/Python-3.13.1",
