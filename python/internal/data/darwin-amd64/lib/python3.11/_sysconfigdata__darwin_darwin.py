...
build_time_vars = {
    ...
    "ALT_SOABI": 0,
    "ANDROID_API_LEVEL": 0,
    "AR": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpbqc8zad6/tools/llvm/bin/llvm-ar",
    "ARFLAGS": "rcs",
    "BASECFLAGS": "",
    "BASECPPFLAGS": "",
    "BASEMODLIBS": "",
    ...
    "BLDSHARED": "clang -bundle -undefined dynamic_lookup -arch x86_64 -mmacosx-version-min=10.9  ",
    "BOOTSTRAP_HEADERS": "\\",
    "BUILDEXE": ".exe",
    ...
    "CC": "clang",
    "CCSHARED": "",
    "CFLAGS": "-DNDEBUG -g -fwrapv -O3 -Wall -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    ",
    "CFLAGSFORSHARED": "",
    ...
    "FREEZE_MODULE": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpbqc8zad6/tools/host/bin/python3.11 ./Programs/_freeze_module.py",
    "FREEZE_MODULE_BOOTSTRAP": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpbqc8zad6/tools/host/bin/python3.11 ./Programs/_freeze_module.py",
    ...
    "LDLIBRARYDIR": "",
    "LDSHARED": "clang -bundle -undefined dynamic_lookup -arch x86_64 -mmacosx-version-min=10.9  ",
    "LDVERSION": "3.11",
    "LIBC": "",
    "LIBDEST": "/install/lib/python3.11",
    "LIBDIR": "/install/lib",
    "LIBEXPAT_A": "Modules/expat/libexpat.a",
    "LIBEXPAT_CFLAGS": "-DNDEBUG -g -fwrapv -O3 -Wall -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=code.profclangd -I./Include/internal -I. -I./Include -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "LIBEXPAT_HEADERS": "\\",
    "LIBEXPAT_OBJS": "\\",
    "LIBFFI_INCLUDEDIR": "",
    "LIBM": "",
    "LIBMPDEC_A": "Modules/_decimal/libmpdec/libmpdec.a",
    "LIBMPDEC_CFLAGS": "-DUNIVERSAL=1 -DNDEBUG -g -fwrapv -O3 -Wall -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=code.profclangd -I./Include/internal -I. -I./Include -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "LIBMPDEC_HEADERS": "\\",
    "LIBMPDEC_OBJS": "\\",
    "LIBOBJDIR": "Python/",
    "LIBOBJS": "",
    ...
    "LLVM_PROF_MERGER": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpbqc8zad6/tools/llvm/bin/llvm-profdata merge -output=code.profclangd *.profclangr",
    "LN": "ln",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpbqc8zad6/Python-3.11.11 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpbqc8zad6/Python-3.11.11/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpbqc8zad6/tools/host/bin/python3.11",
    "PYTHON_FOR_BUILD_DEPS": "",
    "PYTHON_FOR_FREEZE": "/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpbqc8zad6/tools/host/bin/python3.11",
    "PYTHON_FOR_REGEN": "",
    "PYTHON_HEADERS": "\\",
    "PYTHON_OBJS": "\\",
    "PY_BUILTIN_HASHLIB_HASHES": "\"md5,sha1,sha256,sha512,sha3,blake2\"",
    "PY_BUILTIN_MODULE_CFLAGS": "-DNDEBUG -g -fwrapv -O3 -Wall -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=code.profclangd -I./Include/internal -I. -I./Include -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -DPy_BUILD_CORE_BUILTIN",
    "PY_CFLAGS": "-DNDEBUG -g -fwrapv -O3 -Wall -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    ...
    "PY_ENABLE_SHARED": 1,
    "PY_FORMAT_SIZE_T": "\"z\"",
    "PY_LDFLAGS": "-arch x86_64 -mmacosx-version-min=10.9  ",
    "PY_LDFLAGS_NODIST": "-flto -Wl,-export_dynamic -g",
    "PY_LDFLAGS_NOLTO": "-arch x86_64 -mmacosx-version-min=10.9   -flto=thin",
    "PY_SQLITE_ENABLE_LOAD_EXTENSION": 0,
    "PY_SQLITE_HAVE_SERIALIZE": 1,
    "PY_SSL_DEFAULT_CIPHERS": 1,
    "PY_SSL_DEFAULT_CIPHER_STRING": 0,
    "PY_STDMODULE_CFLAGS": "-DNDEBUG -g -fwrapv -O3 -Wall -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new -flto -std=c11 -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=code.profclangd -I./Include/internal -I. -I./Include -arch x86_64 -mmacosx-version-min=10.9 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new",
    "PY_SUPPORT_TIER": 1,
    "Py_DEBUG": 0,
    "Py_ENABLE_SHARED": 1,
    "Py_HASH_ALGORITHM": 0,
    ...
    "RETSIGTYPE": "void",
    "RUNSHARED": "DYLD_LIBRARY_PATH=/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpbqc8zad6/Python-3.11.11",
    ...
    "abs_builddir": "/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpbqc8zad6/Python-3.11.11",
    "abs_srcdir": "/private/var/folders/y4/8dcllrc96x32z0w3fgrlx6_m0000gn/T/tmpbqc8zad6/Python-3.11.11",
