...
build_time_vars = {
    ...
    "AR": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/llvm/bin/llvm-ar",
    "ARFLAGS": "rcs",
    ...
    "CONFIG_ARGS": "'--build=aarch64-apple-darwin' '--host=aarch64-apple-darwin' '--prefix=/install' '--with-openssl=/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/deps' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' '--enable-static-libpython-for-interpreter' '--enable-shared' '--with-mimalloc' '--enable-optimizations' '--enable-experimental-jit=yes-off' '--with-lto' '--with-build-python=/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/host/bin/python3.13' 'ac_cv_lib_intl_textdomain=no' 'ac_cv_func_ptsname_r=no' '--with-dbmliborder=ndbm' 'build_alias=aarch64-apple-darwin' 'host_alias=aarch64-apple-darwin' 'PKG_CONFIG=pkg-config --static' 'PKG_CONFIG_PATH=/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/deps/share/pkgconfig:/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/deps/lib/pkgconfig' 'CC=clang' 'CFLAGS=-O3 -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'LDFLAGS=-arch arm64 -mmacosx-version-min=11.0    -Wl,-headerpad,40' 'CPPFLAGS=-O3 -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix   -fPIC    -Werror=unguarded-availability-new' 'PROFILE_TASK=-m test --pgo -j 7'",
    "CONFINCLUDEDIR": "/install/include",
    "CONFINCLUDEPY": "/install/include/python3.13",
    "COREPYTHONPATH": "",
    "COVERAGE_INFO": "/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13/coverage.info",
    "COVERAGE_LCOV_OPTIONS": "--rc lcov_branch_coverage=1",
    "COVERAGE_REPORT": "/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13/lcov-report",
    ...
    "FILEMODE": 644,
    "FREEZE_MODULE": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/host/bin/python3.13 ./Programs/_freeze_module.py",
    "FREEZE_MODULE_BOOTSTRAP": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/host/bin/python3.13 ./Programs/_freeze_module.py",
    ...
    "LLVM_PROFDATA": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/llvm/bin/llvm-profdata",
    "LLVM_PROF_ERR": "no",
    "LLVM_PROF_FILE": "LLVM_PROFILE_FILE=\"$(shell pwd)/code-%128m.profclangr\"",
    "LLVM_PROF_MERGER": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/llvm/bin/llvm-profdata merge -output=\"$(shell pwd)/code.profclangd\" \"$(shell pwd)\"/*.profclangr",
    "LN": "ln",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13/`cat pybuilddir.txt`) /var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/host/bin/python3.13",
    "PYTHON_FOR_BUILD_DEPS": "",
    "PYTHON_FOR_FREEZE": "/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/host/bin/python3.13",
    "PYTHON_FOR_REGEN": "",
    "PYTHON_HEADERS": "\\",
    "PYTHON_OBJS": "\\",
    ...
    "PY_CFLAGS_NODIST": "-D_Py_TIER2=3 -D_Py_JIT -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13/code.profclangd -I./Include/internal -I./Include/internal/mimalloc",
    ...
    "RESSRCDIR": "",
    "RETSIGTYPE": "void",
    "RUNSHARED": "DYLD_LIBRARY_PATH=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13",
    ...
    "TESTOPTS": "",
    "TESTPATH": "",
    "TESTPYTHON": "DYLD_LIBRARY_PATH=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13 _PYTHON_PROJECT_BASE=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13/`cat pybuilddir.txt`) /var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/host/bin/python3.13",
    "TESTPYTHONOPTS": "",
    "TESTRUNNER": "DYLD_LIBRARY_PATH=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13 _PYTHON_PROJECT_BASE=/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13/`cat pybuilddir.txt`) /var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/tools/host/bin/python3.13 -m test",
    ...
    "abs_builddir": "/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13",
    "abs_srcdir": "/private/var/folders/1r/b8l6nzhj4zdbz5jmjdhqbprw0000gn/T/tmplekht9sx/Python-3.13.13",
