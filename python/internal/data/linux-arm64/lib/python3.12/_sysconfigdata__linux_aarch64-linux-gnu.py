...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--build=x86_64-unknown-linux-gnu' "
                ...
                '-Wl,--exclude-libs,ALL -L/tools/deps/libedit/lib '
                "-LModules/_hacl' 'CPPFLAGS= -fPIC -I/tools/deps/include "
 ...
 'LDSHARED': '/usr/bin/aarch64-linux-gnu-gcc -shared -L/tools/deps/lib '
             '-Wl,--exclude-libs,ALL -L/tools/deps/libedit/lib -LModules/_hacl',
 'LDVERSION': '3.12',
 'LIBC': '',
 ...
 'PY_CORE_LDFLAGS': '-L/tools/deps/lib -Wl,--exclude-libs,ALL '
                    '-L/tools/deps/libedit/lib -LModules/_hacl -flto '
                    '-fuse-linker-plugin -ffat-lto-objects '
                    '-flto-partition=none -g',
 ...
 'PY_LDFLAGS_NOLTO': '-L/tools/deps/lib -Wl,--exclude-libs,ALL '
                     '-L/tools/deps/libedit/lib -LModules/_hacl -fno-lto',
